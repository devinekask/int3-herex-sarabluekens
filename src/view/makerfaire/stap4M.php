...
<section class="stap">
  ...
  <div class="stap__flex hoorn">
    <section class="stap__deel ">
      ...
      <img class="stap__deel--img lang" src="../assets/img/stap3.1.svg" alt="foto van het zagen van een pvc buis." width="308" height="517">
      <p class="stap__deel--text">Lijm het mondstuk op een hoekstuk.</p>
    </section>
    <section class="stap__deel ">
      <h2 class="visually-hidden">Deel 2</h2>
      <img class="stap__deel--img" src="../assets/img/stap3.2.png" alt="foto van het knippen van de vorm van de buis uit plastiek" width="949" height="1080">
    ...
    <section class="stap__deel">
      ...
      <img class="stap__deel--img hoog" src="../assets/img/stap3.3.png" alt="foto van het zagen van een pvc buis." width="949" height="646">
