...
<section class="overzicht">
  ...
  <a class="overzicht__button--terug" href="index.php?page=overzicht"><img src="../assets/img/terug.svg" alt="terug knop die teugkeert naar de homepage" width="107" height="37"></a>
</section>
